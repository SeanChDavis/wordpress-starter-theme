...
function wst_scripts() {
	wp_enqueue_style( 'wst-google-fonts', 'https://fonts.googleapis.com/css2?family=Cal+Sans&family=Red+Hat+Display:ital,wght@0,400;0,700;1,400&display=swap', array(), null );
